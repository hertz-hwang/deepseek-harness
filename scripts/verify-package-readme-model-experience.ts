...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/guard/http-timeout-policy': { kind: 'none', reason: 'The plugin configures undici transport deadlines for the whole process; it registers no prompt, tool, or session event, and each caller owns its own request deadline.' },
